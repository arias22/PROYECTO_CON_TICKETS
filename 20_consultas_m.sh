...
programas_main=(
  "sudo ./main_v3 0 4 4 0"
  "sudo ./main_v3 0 4 4 1"
  "sudo ./main_v3 0 4 4 2"
  "sudo ./main_v3 3 4 4 0" 
  "sudo ./main_v3 3 4 1 1"
  "sudo ./main_v3 2 4 4 0" 
  "sudo ./main_v3 2 4 4 1"
  "sudo ./main_v3 2 4 4 2"
  "sudo ./main_v3 1 4 4 0"
  "sudo ./main_v3 1 4 4 1"
  "sudo ./main_v3 1 4 1 2"
  "sudo ./main_v3 1 4 4 3"
  "sudo ./main_v3 1 4 4 4"
  "sudo ./main_v3 0 4 4 3"
  "sudo ./main_v3 0 4 4 4"
  "sudo ./main_v3 3 4 4 2"
  "sudo ./main_v3 3 4 4 3"
  "sudo ./main_v3 3 4 4 4"
  "sudo ./main_v3 2 4 4 3"
  "sudo ./main_v3 2 4 4 4"
)
